...
//	var backPath;
//
//	this.setBackPath = function setBackPath(path) {
//		backPath = path;
//	}
//
//	this.getBackPath = function setBackPath() {
//		return backPath;
//	}
//
//	this.clearBackPath = function clearBackPath() {
//		backPath = null;
//	}
	...
	this.isAuthorized = function isAuthorized(req, key, options){
		...
		var ret = authen[key];
		console.log("★isAuthorized[" + key + "," + options + "] => "+ret);
		return ret
	}
	...
	this.isNotAuthorized = function isNotAuthorized(req, key, options){
		var authen = this.getAuthenData(req, options);
		var ret = !authen[key];
		console.log("★isNotAuthorized[" + key + "," + options + "] => "+ret);
		return ret;
	}
